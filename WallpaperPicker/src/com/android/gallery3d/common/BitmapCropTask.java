...
public class BitmapCropTask extends AsyncTask<Integer, Void, Boolean> {
    ...
    ///M: AOSP CROP has some bugs and may lead to crop fail.
    private static final boolean USE_ERROR_CROP = false;
    ...
    public boolean cropBitmap(int whichWallpaper) {
        ...
        if (mSetWallpaper && mNoCrop) {
            ...
            return !failure;
        } else if (USE_ERROR_CROP && mSetWallpaper && Utilities.ATLEAST_N
            ...
            if (crop == null) {
                ...
                if (is != null) {
                    ...
                    try {
                         ...
                         Log.e(LOGTAG, "Failed to decodeStreamI " + is, e);
                         return false;
                    }  finally {
                       Utils.closeSilently(is);
                    }
                ...
                if (fullSize != null) {
                    ...
                    ///M: ALPS02816349 Fix invalid crop size.
                    if (roundedTrueCrop.width() <= 0 || roundedTrueCrop.height() <= 0) {
                        Log.w(LOGTAG, "crop has bad values for full size image");
                        failure = true;
                        return false;
                    ...
                    try {
                         ...
                         Log.w(LOGTAG, "Wallpaper too large, createBitmap fail");
                    }
                }
            }
    ...
    protected void onPostExecute(Boolean cropSucceeded) {
		...
		//add by luoran for add toast 20161102(start)
		//Toast.makeText(mContext, R.string.wallpaper_set_successful, Toast.LENGTH_SHORT).show();
		//add by luoran for add toast 20161102(end)
    }
