...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        MTKUnreadLoader.drawUnreadEventIfNeed(canvas, this);//add unread feature by zhaopenglin DWEQLSY-351
    }
    ...
    public void onAdd(ShortcutInfo item) {
         ...
         * added for unread feature, when add a item to a folder, we need to update
    ...
    public void onRemove(ShortcutInfo item) {
        ...
        /**add unread feature by zhaopenglin DWEQLSY-351 start
         *  added for Unread feature, when remove a item from a folder, we need to update
         *  the unread num of the folder.@{
         */
        final ComponentName componentName = item.intent.getComponent();
        updateFolderUnreadNum(componentName, item.unreadNum);
