...
public class LauncherAppsCompatVL extends LauncherAppsCompat {
    ...
    //Add BUG_ID:DWEQBSE-20 jia.liu for hide app in launcher20161207(start)
    private Context mContext;
    private List<String> hideappsArrayList = new ArrayList<String>();
    //Add BUG_ID:DWEQBSE-20 jia.liu for hide app in launcher20161207(end)

    LauncherAppsCompatVL(Context context) {
        super();
        mLauncherApps = (LauncherApps) context.getSystemService("launcherapps");
        mContext = context;//Add BUG_ID:DWEQBSE-20 jia.liu for hide app in launcher20161207
    }
    ...
    public List<LauncherActivityInfoCompat> getActivityList(String packageName,
        ...
        //A BUG_ID:DWEQBSE-20 jia.liu for hide app in launcher20161207(start)
        ...
        //A BUG_ID:DWEQBSE-20 jia.liu for hide app in launcher20161207(end)
            for (LauncherActivityInfo info : list) {
