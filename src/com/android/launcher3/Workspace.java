...
public class Workspace extends PagedView
    ...
    public long addNewScreen() {
        ...
        // newScreen.getEmptyScreenHelper().setDefaultHome(true);
        newScreen.setOnLongClickListener(mLongClickListener);
        newScreen.setOnClickListener(mLauncher);
        newScreen.setSoundEffectsEnabled(false);
        ...
        setCurrentPage(Math.max(0, Math.min(insertIndex, getChildCount() - 1)));
    ...
    private void convertFinalScreenToEmptyScreenIfNecessary() {
		//add by luoran for modify add screen bug 20170821(start)
		if(mLauncher.getResources().getBoolean(R.bool.is_support_mhl)){
			return;
        }
		//add by luoran for modify add screen bug 20170821(end)
    ...
    public void stripEmptyScreens() {
        ...
        if (getResources().getBoolean(R.bool.is_positivo_launcher) || !removeScreens.isEmpty()) {
            // Update the model if we have changed any screens
            mLauncher.getModel().updateWorkspaceScreenOrder(mLauncher, mScreenOrder);
        }
