...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public void animateOpen() {
        updateContentUnreadNum();//add unread feature by zhaopenglin DWEQLSY-351
        if (!(getParent() instanceof DragLayer)) return;
    ...
    private int getFolderHeight() {
        return mLauncher.getResources().getDimensionPixelOffset(R.dimen.folder_height);//getFolderHeight(getContentAreaHeight());//modify folder taoqi
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
	  ...
	  mFolderNameLv.measure(contentAreaWidthSpec,50);
        ...
        int folderWidth = 880;//modify folder taoqi
