                    ...
                    if (pageUnderPointIndex > -1 && pageUnderPointIndex != indexOfChild(mDragView)) {
                        ...
                        if (mTempVisiblePagesRange[0] <= pageUnderPointIndex &&
                            ...
                            mSidePageHoverRunnable = new Runnable() {
                                @Override
                                public void run() {
								//modify by luoran for positivo launcher(start)
                                if (!(getResources().getBoolean(R.bool.is_positivo_launcher)) || !(getChildAt(pageUnderPointIndex) instanceof CellLayoutCreator)) {
                                ...
                                for (int i = lowerIndex; i <= upperIndex; ++i) {
									...
									//modify by luoran for positivo launcher(end)
                                }
                            };
