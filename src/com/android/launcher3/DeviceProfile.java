...
public class DeviceProfile {
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources res,
		...
		if(res.getBoolean(R.bool.is_rm_qsb)) normalSearchBarSpaceHeightPx /= 3;
        ...
        folderCellHeightPx = cellHeightPx + 3*edgeMarginPx+5;//change edgeMarginPx to 3*edgeMarginPx by zhaopenglin DWEQLSY-500
    ...
    public void layout(Launcher launcher) {
        ...
        if (hasVerticalBarLayout) {
			...
			//add by luoran for positivo mhl launcher(start)
			if(launcher.getResources().getBoolean(R.bool.is_positivo_launcher)){
				lp.topMargin -= 80;
			}
			//add by luoran for positivo mhl launcher(end)
        }
