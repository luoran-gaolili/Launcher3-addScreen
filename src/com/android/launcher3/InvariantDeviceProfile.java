...
public class InvariantDeviceProfile {
    ...
    InvariantDeviceProfile(Context context) {
	 ...
	 //modify by luoran for reduce icon size(start)
        if(context.getResources().getBoolean(R.bool.is_rgk_support_bgicon)){
		iconSize = interpolatedDeviceProfileOut.iconSize - 4;
	       hotseatIconSize = interpolatedDeviceProfileOut.hotseatIconSize - 4;
        }else{
             iconSize = interpolatedDeviceProfileOut.iconSize ;
             hotseatIconSize = interpolatedDeviceProfileOut.hotseatIconSize ;
        }
	 //modify by luoran for reduce icon size(end)
